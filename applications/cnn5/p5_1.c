 ...
 * @date November 2024
 *
 * @brief Layer 3 (AlexNet Conv3) worker 1: receives IN_DEPTH_3/P5_AMONT_OF_PES
...
#include "p5_1_weights.h"

#define CHANNEL 1

int main()
{
	puts("Inicio da aplicacao p5_1");
    int i;
