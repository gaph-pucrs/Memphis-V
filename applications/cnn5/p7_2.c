 ...
 * @date November 2024
 *
 * @brief Layer 4 (AlexNet Conv4) worker 2: receives IN_DEPTH_4/P7_AMONT_OF_PES
...
#include "p7_2_weights.h"

#define CHANNEL 2

int main()
{
	puts("Inicio da aplicacao p7_2");
    int i;
