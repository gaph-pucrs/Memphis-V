 ...
 * @date November 2024
 *
 * @brief Layer 4 (AlexNet Conv4) worker 0: receives IN_DEPTH_4/P7_AMONT_OF_PES
...
#include "p7_0_weights.h"

#define CHANNEL 0

int main()
{
	puts("Inicio da aplicacao p7_0");
    int i;

    int IN_DEPTH_4_LOCAL = (IN_DEPTH_4/P7_AMONT_OF_PES);

	unsigned long long *time_rec  = malloc(IN_DEPTH_4_LOCAL*sizeof(unsigned long long));
	unsigned long long *time_recd = malloc(IN_DEPTH_4_LOCAL*sizeof(unsigned long long));
	unsigned long long *time_pad  = malloc(IN_DEPTH_4_LOCAL*sizeof(unsigned long long));

    unsigned long long *time_start  = malloc(OUT_DEPTH_4*sizeof(unsigned long long));
    unsigned long long *time_finish = malloc(OUT_DEPTH_4*sizeof(unsigned long long));
