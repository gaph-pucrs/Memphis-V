 ...
 * @date November 2024
 *
 * @brief Layer 4 (AlexNet Conv4) worker 4: receives IN_DEPTH_4/P7_AMONT_OF_PES
...
#include "p7_4_weights.h"

#define CHANNEL 4

int main()
{
	puts("Inicio da aplicacao p7_4");
    int i;
