 ...
 * @date November 2024
 *
 * @brief Layer 4 (AlexNet Conv4) worker 1: receives IN_DEPTH_4/P7_AMONT_OF_PES
...
#include "p7_1_weights.h"

#define CHANNEL 1

int main()
{
	puts("Inicio da aplicacao p7_1");
    int i;
